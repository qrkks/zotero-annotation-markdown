...
12. Open the outline, switch between eligible annotations and Reader tabs, and restart Zotero. The next outline remains open. Close it and repeat; temporary editing or a heading-free annotation must not overwrite the closed/open choice.
